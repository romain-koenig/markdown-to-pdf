function About() {
	return (
		<div className="container">
			...
			<p>Welcome to my pet project, the Markdown to PDF Converter.
				...
				As you explore this app, please handle it with care.
				Your feedback and suggestions are always welcome as they contribute to my learning process.
